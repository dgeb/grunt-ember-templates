...
*Important: the latest version of this plugin is only compatible with grunt.js 0.4.0rc7. For compatibility with grunt.js 0.3, please use ~0.3 of this plugin.*
