...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push(escapeExpression(((stack1 = helpers.spaces || (depth0 && depth0.spaces)),stack1 ? stack1.call(depth0, "in", "handlebars", "tags", options) : helperMissing.call(depth0, "spaces", "in", "handlebars", "tags", options))));
