...
var emberBowerPath = 'bower_components/ember/bower.json';

exports.default = {
  setUp: function (callback) {
    this.version = JSON.parse(fs.readFileSync(emberBowerPath, 'utf8')).version;
    callback();
  },
  ...
  amd: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/amd.js');
  ...
  amd_custom: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/amd_custom.js');
  ...
  file_pattern_matching: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/file_pattern_matching.js');
  ...
  custom_file_extensions: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/custom_file_extensions.js');
  ...
  truncate_base_path: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/truncate_base_path.js');
  ...
  custom_template_name: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/custom_template_name.js');
  ...
  custom_template_name_from_file: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/custom_template_name_from_file.js');
  ...
  minify: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/preprocess.js');
  ...
  skip_precompile: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/skip_precompile.js');
  ...
  custom_registration: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/custom_registration.js');
  ...
  concatenate_disabled: function (test) {
    ...
    var expected = grunt.file.read('test/expected/' + this.version + '/text.js');
    test.equal(actual, expected, desc);

    actual = grunt.file.read('tmp/dest/test/fixtures/simple.js');
    expected = grunt.file.read('test/expected/' + this.version + '/simple.js');
    test.equal(actual, expected, desc);
